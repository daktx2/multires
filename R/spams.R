...
`m_ones` = function(nb)
{
  ...
  ;ans = .Call('R_swig_m_ones', nb, PACKAGE='multires');
...
{
  s = as(s, "character"); 
  ;.Call('R_swig_skip_space', s, PACKAGE='multires');
...
`parse_line` = function(s, vresult, .copy = FALSE)
{
  ...
  ;.Call('R_swig_parse_line', s, vresult, as.logical(.copy), PACKAGE='multires');
...
{
  s = as(s, "character"); 
  ;ans = .Call('R_swig_intlist', s, PACKAGE='multires');
...
`sort` = function(v, mode)
{
  ...
  ;.Call('R_swig_sort', v, mode, PACKAGE='multires');
...
`mult` = function(X, Y, XY, transX, transY, a, b)
{
  ...
  ;.Call('R_swig_mult', X, Y, XY, transX, transY, a, b, PACKAGE='multires');
...
`AAt` = function(A, B)
{
  ...
  ;.Call('R_swig_AAt', A, B, PACKAGE='multires');
...
`XAt` = function(A, X, XAt)
{
  ...
  ;.Call('R_swig_XAt', A, X, XAt, PACKAGE='multires');
...
`applyBayerPattern` = function(v, offset)
{
  ...
  ;.Call('R_swig_applyBayerPattern', v, offset, PACKAGE='multires');
...
`conjugateGradient` = function(A, b, x, tol, itermax)
{
  ...
  ;.Call('R_swig_conjugateGradient', A, b, x, tol, itermax, PACKAGE='multires');
...
{
  if (inherits(A, "ExternalReference")) A = slot(A,"ref") 
  ;.Call('R_swig_invSym', A, PACKAGE='multires');
...
{
  if (inherits(A, "ExternalReference")) A = slot(A,"ref") 
  ;.Call('R_swig_normalize', A, PACKAGE='multires');
...
`sparseProject` = function(U, V, thrs, mode, lambda1, lambda2, lambda3, pos, numThreads)
{
  ...
  ;.Call('R_swig_sparseProject', U, V, thrs, mode, lambda1, lambda2, lambda3, pos, numThreads, PACKAGE='multires');
...
`lassoD` = function(X, D, return_reg_path, L, constraint, lambda2, mode, pos, ols, numThreads, max_length_path, verbose, cholevsky)
{
  ...
  ;ans = .Call('R_swig_lassoD', X, D, return_reg_path, L, constraint, lambda2, mode, pos, ols, numThreads, max_length_path, verbose, cholevsky, PACKAGE='multires');
...
`lassoQq` = function(X, Q, q, return_reg_path, L, constraint, lambda2, mode, pos, ols, numThreads, max_length_path, verbose, cholevsky)
{
  ...
  verbose = as.logical(verbose);
  cholevsky = as.logical(cholevsky);
  ;ans = .Call('R_swig_lassoQq', X, Q, q, return_reg_path, L, constraint, lambda2, mode, pos, ols, numThreads, max_length_path, verbose, cholevsky, PACKAGE='multires');
  #ans <- new("_p_SpMatrixT_double_t", ref=ans) ;
...
`lassoMask` = function(X, D, B, L, constraint, lambda2, mode, pos, numThreads, verbose)
{
  ...
  verbose = as.logical(verbose);
  ;ans = .Call('R_swig_lassoMask', X, D, B, L, constraint, lambda2, mode, pos, numThreads, verbose, PACKAGE='multires');
  #ans <- new("_p_SpMatrixT_double_t", ref=ans) ;
...
`lassoWeighted` = function(X, D, W, L, constraint, mode, pos, numThreads, verbose)
{
  ...
  verbose = as.logical(verbose);
  ;ans = .Call('R_swig_lassoWeighted', X, D, W, L, constraint, mode, pos, numThreads, verbose, PACKAGE='multires');
  #ans <- new("_p_SpMatrixT_double_t", ref=ans) ;
...
`omp` = function(X, D, return_reg_path, given_L, L, given_eps, eps, given_Lambda, Lambda, numThreads)
{
  ...
  ;ans = .Call('R_swig_omp', X, D, return_reg_path, given_L, L, given_eps, eps, given_Lambda, Lambda, numThreads, PACKAGE='multires');
  #ans <- new("_p_SpMatrixT_double_t", ref=ans) ;
...
`ompMask` = function(X, D, B, return_reg_path, given_L, L, given_eps, eps, given_Lambda, Lambda, numThreads)
{
  ...
  ;ans = .Call('R_swig_ompMask', X, D, B, return_reg_path, given_L, L, given_eps, eps, given_Lambda, Lambda, numThreads, PACKAGE='multires');
  #ans <- new("_p_SpMatrixT_double_t", ref=ans) ;
...
`somp` = function(X, D, groups, LL, eps, numThreads)
{
  ...
  ;ans = .Call('R_swig_somp', X, D, groups, LL, eps, numThreads, PACKAGE='multires');
  #ans <- new("_p_SpMatrixT_double_t", ref=ans) ;
...
`cd` = function(X, D, alpha, lambda1, mode, itermax, tol, numThreads)
{
  ...
  ;ans = .Call('R_swig_cd', X, D, alpha, lambda1, mode, itermax, tol, numThreads, PACKAGE='multires');
  #ans <- new("_p_SpMatrixT_double_t", ref=ans) ;
...
`l1L2BCD` = function(X, D, alpha0, groups, lambda1, mode, itermax, tol, numThreads)
{
  ...
  ;.Call('R_swig_l1L2BCD', X, D, alpha0, groups, lambda1, mode, itermax, tol, numThreads, PACKAGE='multires');
...
`archetypalAnalysis` = function(X, p, robust, epsilon, computeXtX, stepsFISTA, stepsAS, randominit, numThreads)
{
  ...
  ;ans = .Call('R_swig_archetypalAnalysis', X, p, robust, epsilon, computeXtX, stepsFISTA, stepsAS, randominit, numThreads, PACKAGE='multires');
  #ans <- new("_p_MatrixT_double_t", ref=ans) ;
...
`archetypalAnalysisInit` = function(X, Z0, robust, epsilon, computeXtX, stepsFISTA, stepsAS, numThreads)
{
  ...
  ;ans = .Call('R_swig_archetypalAnalysisInit', X, Z0, robust, epsilon, computeXtX, stepsFISTA, stepsAS, numThreads, PACKAGE='multires');
  #ans <- new("_p_MatrixT_double_t", ref=ans) ;
...
`decompSimplex` = function(X, Z, computeXtX, numThreads)
{
  ...
  ;ans = .Call('R_swig_decompSimplex', X, Z, computeXtX, numThreads, PACKAGE='multires');
  #ans <- new("_p_SpMatrixT_double_t", ref=ans) ;
...
`fistaTree` = function(X, D, alpha0, alpha, eta_g, groups, own_variables, N_own_variables, num_threads, max_it, L0, fixed_step, gamma, s_lambda, delta, lambda2, lambda3, a, b, c, tol, it0, max_iter_backtracking, compute_gram, lin_admm, admm, intercept, resetflow, name_regul, name_loss, verbose, pos, clever, log, ista, subgrad, logName, is_inner_weights, inner_weights, size_group, sqrt_step, transpose, linesearch_mode,choler,invcholer,eigenvalinv)
{
  ...
  if (inherits(own_variables, "ExternalReference")) own_variables = slot(own_variables,"ref") 
  if (inherits(N_own_variables, "ExternalReference")) N_own_variables = slot(N_own_variables,"ref")
  if (inherits(choler, "ExternalReference")) choler = slot(choler,"ref")
  if (inherits(invcholer, "ExternalReference")) invcholer = slot(invcholer,"ref")
  if (inherits(eigenvalinv, "ExternalReference")) eigenvalinv = slot(eigenvalinv,"ref")
  num_threads = as.integer(num_threads);
  if(length(num_threads) > 1) {
    warning("using only the first element of num_threads");
  };
...
`proximalFlat` = function(alpha0, alpha, groups, num_threads, lambda1, lambda2, lambda3, intercept, resetflow, name_regul, verbose, pos, clever, eval, size_group, transpose)
{
  ...
  transpose = as.logical(transpose);
  ;ans = .Call('R_swig_proximalFlat', alpha0, alpha, groups, num_threads, lambda1, lambda2, lambda3, intercept, resetflow, name_regul, verbose, pos, clever, eval, size_group, transpose, PACKAGE='multires');
...
`proximalTree` = function(alpha0, alpha, eta_g, groups, own_variables, N_own_variables, num_threads, lambda1, lambda2, lambda3, intercept, resetflow, name_regul, verbose, pos, clever, eval, size_group, transpose)
{
  ...
  transpose = as.logical(transpose);
  ;ans = .Call('R_swig_proximalTree', alpha0, alpha, eta_g, groups, own_variables, N_own_variables, num_threads, lambda1, lambda2, lambda3, intercept, resetflow, name_regul, verbose, pos, clever, eval, size_group, transpose, PACKAGE='multires');
  #ans <- new("_p_VectorT_double_t", ref=ans) ;
...
`proximalGraph` = function(alpha0, alpha, eta_g, groups, groups_var, num_threads, lambda1, lambda2, lambda3, intercept, resetflow, name_regul, verbose, pos, clever, eval, size_group, transpose)
{
  ...
  transpose = as.logical(transpose);
  ;ans = .Call('R_swig_proximalGraph', alpha0, alpha, eta_g, groups, groups_var, num_threads, lambda1, lambda2, lambda3, intercept, resetflow, name_regul, verbose, pos, clever, eval, size_group, transpose, PACKAGE='multires');
  #ans <- new("_p_VectorT_double_t", ref=ans) ;
...
`simpleGroupTree` = function(degr, n)
{
  ...
  ;ans = .Call('R_swig_simpleGroupTree', degr, n, PACKAGE='multires');
...
`readGroupStruct` = function(file)
{
  ...
  ;ans = .Call('R_swig_readGroupStruct', file, PACKAGE='multires');
  #ans <- new("_p_std__vectorT_StructNodeElemT_double_t_p_t", ref=ans) ;
...
`groupStructOfString` = function(data)
{
  ...
  ;ans = .Call('R_swig_groupStructOfString', data, PACKAGE='multires');
  #ans <- new("_p_std__vectorT_StructNodeElemT_double_t_p_t", ref=ans) ;
...
`graphOfGroupStruct` = function(gstruct)
{
  ...
  ;ans = .Call('R_swig_graphOfGroupStruct', gstruct, PACKAGE='multires');
  #ans <- new("_p_VectorT_double_t", ref=ans) ;
...
{
  if (inherits(gstruct, "ExternalReference")) gstruct = slot(gstruct,"ref") 
  ;.Call('R_swig_treeOfGroupStruct', gstruct, as.logical(.copy), PACKAGE='multires');
...
`im2col_sliding` = function(A, B, m, n, RGB)
{
  ...
  RGB = as.logical(RGB);
  ;.Call('R_swig_im2col_sliding', A, B, m, n, RGB, PACKAGE='multires');
