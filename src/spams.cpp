...
extern "C" {
  ...
  SWIGEXPORT SEXP
  R_swig_fistaTree ( SEXP X, SEXP D, SEXP alpha0, SEXP alpha, SEXP eta_g, SEXP groups, SEXP own_variables, SEXP N_own_variables, SEXP num_threads, SEXP max_it, SEXP L0, SEXP fixed_step, SEXP gamma, SEXP s_lambda, SEXP delta, SEXP lambda2, SEXP lambda3, SEXP a, SEXP b, SEXP c, SEXP tol, SEXP it0, SEXP max_iter_backtracking, SEXP compute_gram, SEXP lin_admm, SEXP admm, SEXP intercept, SEXP resetflow, SEXP name_regul, SEXP name_loss, SEXP verbose, SEXP pos, SEXP clever, SEXP log, SEXP ista, SEXP subgrad, SEXP logName, SEXP is_inner_weights, SEXP inner_weights, SEXP size_group, SEXP sqrt_step, SEXP transpose, SEXP linesearch_mode, SEXP choler, SEXP invcholer, SEXP eigenvalinv)
  {
    Matrix< double > *result = 0 ;
    Matrix< double > *arg1 = (Matrix< double > *) 0 ;
    AbstractMatrixB< double > *arg2 = (AbstractMatrixB< double > *) 0 ;
    ...
    bool arg42 ;
    int arg43 ;
    /*DAN KIRSNER EDIT FOR TIKHONOV*/
    AbstractMatrixB< double > *arg44 = (AbstractMatrixB< double > *) 0 ;
    Matrix< double > *arg45 = (Matrix< double > *) 0 ;
    Matrix< double > *arg46 = (Matrix< double > *) 0 ;
    unsigned int r_nprotect = 0;
    SEXP r_ans = R_NilValue ;
    VMAXTYPE r_vmax = vmaxget() ;
    ...
    /*arg44, which is the cholesky we need for the norm, cholesky of the inverse*/
    {
      SEXP pvec = Rf_getAttrib(choler,Rf_install("p"));
      if(pvec ==  R_NilValue) {
        /*@SWIG:R_typemaps.i,113,map_matrix@*/
        SEXP rmat=choler;
        SEXP dims = Rf_getAttrib(rmat,Rf_install("dim"));
        if (TYPEOF(rmat) != REALSXP || LENGTH(dims) != 2)
        {
          /*SG_ERROR("Expected Double Vector as argument %d\n", m_rhs_counter);*/
          {
            Rf_error("Expected double dense matrix as argument %d",44); return R_NilValue;
          };
        }
        arg44 = new Matrix<double> ((double *)REAL(rmat),Rf_nrows(rmat),Rf_ncols(rmat));
        ...
        if (TYPEOF(xvec) != REALSXP || LENGTH(dims) != 2)
        {
          /*SG_ERROR("Expected Double Vector as argument %d\n", m_rhs_counter);*/
          {
            Rf_error("Expected double sparse matrix as argument %d",44); return R_NilValue;
          };
        }
        int *pB = INTEGER(pvec);
        int *pE = pB + 1;
        int *idims = INTEGER(dims);
        arg44 = new SpMatrix<double> ((double *)REAL(xvec),INTEGER(ivec),pB,pE,idims[0],idims[1],LENGTH(xvec));
        
        /*@SWIG@*/
      }
    }
    /*arg45, which is the matrix of eigenvectors of the inverse, doesn't need to be sparse*/
    {
      /*@SWIG:R_typemaps.i,113,map_matrix@*/
      SEXP rmat=invcholer;
      SEXP dims = Rf_getAttrib(rmat,Rf_install("dim"));
      if (TYPEOF(rmat) != REALSXP || LENGTH(dims) != 2)
      {
        /*SG_ERROR("Expected Double Vector as argument %d\n", m_rhs_counter);*/
        {
          Rf_error("Expected double dense matrix as argument %d",45); return R_NilValue;
        };
      }
      arg45 = new Matrix<double> ((double *)REAL(rmat),Rf_nrows(rmat),Rf_ncols(rmat));
      /*@SWIG@*/
    }
    
    {
      /*@SWIG:R_typemaps.i,113,map_matrix@*/
      SEXP rmat=eigenvalinv;
      SEXP dims = Rf_getAttrib(rmat,Rf_install("dim"));
      if (TYPEOF(rmat) != REALSXP || LENGTH(dims) != 2)
      {
        /*SG_ERROR("Expected Double Vector as argument %d\n", m_rhs_counter);*/
        {
          Rf_error("Expected double dense matrix as argument %d",46); return R_NilValue;
        };
      }
      arg46 = new Matrix<double> ((double *)REAL(rmat),Rf_nrows(rmat),Rf_ncols(rmat));
    ...
    try {
      result = (Matrix< double > *)_fistaTree< double >(arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9,arg10,arg11,arg12,arg13,arg14,arg15,arg16,arg17,arg18,arg19,arg20,arg21,arg22,arg23,arg24,arg25,arg26,arg27,arg28,arg29,arg30,arg31,arg32,arg33,arg34,arg35,arg36,arg37,arg38,arg39,arg40,arg41,arg42,arg43,arg44,arg45,arg46);
    }
    catch(char const *_e) {
      Rf_error("Runtime Error %s",_e);
      return R_NilValue;
...
SWIGINTERN R_CallMethodDef CallEntries[] = {
  ...
  {"R_swig_fistaTree", (DL_FUNC) &R_swig_fistaTree, 46},
